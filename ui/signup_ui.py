...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.image.setGeometry(QtCore.QRect(590, 350, 421, 341))
...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(80, 210, 241, 21))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(14)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.pushButtonGoogleSignUp = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonGoogleSignUp.setGeometry(QtCore.QRect(80, 260, 431, 51))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.pushButtonGoogleSignUp.setFont(font)
        self.pushButtonGoogleSignUp.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButtonGoogleSignUp.setStyleSheet("QPushButton {\n"
"width: 100%; height: 100%; background: #FFA3BE; border-radius: 5px; color: white;\n"
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/sudhi-sundar-dutta/Desktop/DOCS_CLONE/ui/../resources/images/flat-color-icons_google.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonGoogleSignUp.setIcon(icon)
        self.pushButtonGoogleSignUp.setIconSize(QtCore.QSize(28, 28))
        self.pushButtonGoogleSignUp.setObjectName("pushButtonGoogleSignUp")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(80, 330, 431, 17))
        ...
        self.email.setGeometry(QtCore.QRect(80, 490, 54, 17))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.password.setGeometry(QtCore.QRect(80, 590, 91, 17))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.lineEditEmail.setGeometry(QtCore.QRect(80, 520, 431, 51))
...
"}")
        ...
        self.lineEditPassword.setGeometry(QtCore.QRect(80, 630, 431, 51))
        self.lineEditPassword.setStyleSheet("QLineEdit {\n"
"width: 100%; height: 100%; background: #FFA3BE; border-radius: 5px; padding-left: 20px;\n"
"}")
        self.lineEditPassword.setObjectName("lineEditPassword")
        self.pushButtonEmail = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonEmail.setGeometry(QtCore.QRect(80, 730, 431, 41))
        font = QtGui.QFont()
...
"}")
        ...
        self.label_4.setGeometry(QtCore.QRect(110, 790, 151, 20))
        font = QtGui.QFont()
        font.setFamily("Lato")
        ...
        self.accountLabel.setGeometry(QtCore.QRect(260, 790, 121, 21))
        font = QtGui.QFont()
        font.setFamily("Lato")
        ...
        self.logInLabel.setGeometry(QtCore.QRect(400, 790, 61, 20))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.fullName.setGeometry(QtCore.QRect(80, 390, 91, 17))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.lineEditFullName.setGeometry(QtCore.QRect(80, 420, 431, 51))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Hi, welcome to Docs Clone!"))
        self.pushButtonGoogleSignUp.setText(_translate("MainWindow", "Signup with Google"))
        self.label_6.setText(_translate("MainWindow", "---------------------------------------   or SignUp with Email   ----------------------------------------"))
